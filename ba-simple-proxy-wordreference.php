...
// Restricted to api.wordreference.com
//
...
$allowed_url = "http://api.wordreference.com";
...
} else if ( substr( $url, 0, strlen( $allowed_url ) ) != $allowed_url) {
	
  //passed url isn't for the allowed domain
  $contents = 'ERROR: invalid url (must begin with '.$allowed_url.')';
  $status = array( 'http_code' => 'ERROR' );
